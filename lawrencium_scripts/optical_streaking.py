...
def multiplepulses(masterscriptfile,dirstr,stepindx,wlaslist,wenvlist,Ilist,CEPlist,tstartlist,timestep,measurementtimestep,measurementtime):
    ...
    multiplepulsedict={"#numpulses#":str(numpulses), "#pulsetypelist#":pulsetypestr, "#omega2list#":wlasstr, "#omegalist#":wenvstr, "#intensitylist#":Istr, "#CEPlist#":CEPstr, "#pulsestartlist#":tstartstr, '#timestep#':str(timestep), "#measurementtimestep#":str(measurementtimestep), "#tfinal#":str(tfinal)}
...
def streakingcalculation(resultdir,calcindx,txuvoffsetlist,CEPlist,wenvlist,\
                         wlaslist,Ilist,timestep,tmeasure,measurementtimestep):
    ...
    multiplepulses(masterscriptfile,dirstr,1,wlaslist,wenvlist,Ilist,CEPlist[CEPindx],tstartlist,timestep,measurementtimestep,tmeasure)
...
shutil.copy("./optical_streaking.py",resultdir)
...
dE=.5#.5#desired energy resolution in eV
maxE=100.#20.#desired maximum energy range in eV
nphase=60#48#128#number of phase points for IR laser
...
for calcindx in range(ncalcs):
    streakingcalculation(resultdir,calcindx,txuvoffsetlist,\
                         CEPlist,wenvlist,wlaslist,Ilist,\
