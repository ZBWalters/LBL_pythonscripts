...
def FWHM_to_wenv(FWHM_as):
    return pi/(FWHM_as*2/aut)
...
XUVduration=250#11e3
XUVwenv=FWHM_to_wenv(XUVduration)



dE=.08#.08#desired energy resolution in eV
...
dtstop=10.
deltadt=.25#
dtarray=arange(dtstart,dtstop+deltadt,deltadt)*1000/aut
ndt=len(dtarray)
